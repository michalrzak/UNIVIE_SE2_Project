...
public class Transaction {
     ...
     *
     * TODO: There is a better way for sure and I don't like that this is here. In the future
     *  in roomDB we will be able to have an automatic key, however I am unsure how to solve this here
     */
     ...
     */
    protected Transaction(int id, @Nullable Category category, @NonNull ETransactionType type, int amount) {
        this.id = id;
        this.category = category;
        this.type = type;
