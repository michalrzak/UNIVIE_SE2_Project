...
public abstract class ACategoryActivity extends AppCompatActivity {
  ...
  /**
   * Override this to define the action of the submit button
   * This method needs to be public due to the way it is bound to onClick
   *
   * @param view not used
   */
  ...
  /**
   * Override this to define the action of the delete button
   * This method needs to be public due to the way it is bound to onClick
   *
   * @param view not used
   */
  ...
  /**
   * Method which gathers the filled in parameters and returns the resulting category
